...
from .views import content, PostList, sign_me, PostDetail, PostCreate, PostUpdate, PostDelete, IndexView, ResponseCreate, ResponseList, ResponseDelete, ResponseDetail, AllResponseList
